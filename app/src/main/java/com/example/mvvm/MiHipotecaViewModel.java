        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                simulador.calcular(solicitud, new SimuladorHipoteca.Callback() {
                    ...
                    @Override
                    public void cuandoHayaErrorDeCapital(double fallo1) {
                        errorCapital.postValue(fallo1);
                    }

                    @Override
                    public void cuandoHayaErrorDePlazo(int fallo2) {
                        errorPlazos.postValue(fallo2);
                    }
                    @Override
